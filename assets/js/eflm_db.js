...
const EFLM_DB = {
  ...
  glucose:      { name:'Glucose',           unit:'mmol/L',cvi:5.0,  cvg:7.5,  ref:{lo:3.9,  hi:6.1,  cutoff:7.0, dir:'upper', note:'Fasting ref. interval; ≥7.0 = diabetes'} },
  hba1c:        { name:'HbA1c',             unit:'%',     cvi:1.9,  cvg:3.7,  ref:{hi:6.0,  cutoff:6.5, dir:'upper', note:'Normal <6%; ≥6.5% = diabetes'} },
